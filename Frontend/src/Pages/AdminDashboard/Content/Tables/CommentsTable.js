...
function CommentsTable({ data, columns }) {
  ...
  const handleAdminActionModal = (id) => {
    dispatch(adminActions.changeIsAdminActionsModalOpen());
    dispatch(adminActions.changeAction('comment_delete'));
    dispatch(adminActions.changeCommentId(id));
  };

  return (
    <>
      <div className='flex justify-between items-center'>
        <div className='text-xl font-semibold'>Wszystkie komentarze ({rowCount})</div>
              ...
              <td className='flex my-1 gap-2'>
                <span
                  ...
                  onClick={() => {
                    ...
                    dispatch(adminActions.changeCommentId(row.original.id));
                  }}
                >
