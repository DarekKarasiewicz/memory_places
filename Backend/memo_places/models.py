...
class Place(models.Model):
    ...
    wiki_link     = models.CharField(max_length=64, default=None)
    topic_link    = models.CharField(max_length=64, default=None)
    img           = models.CharField(max_length=256, default=None)